...
`GET /openapi.yaml`, `GET /documentation`, and `GET /reference` (liveness/readiness probes and
API documentation), `POST /refusal/verify` and `POST /audit/verify` (unauthenticated,
