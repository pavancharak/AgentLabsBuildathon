...
account. `packages/connector-hubspot/`, `docs/CLAIMS.md` §3.10. This was the second connector
in this codebase (after Razorpay, since removed in full 2026-08-12 — see `docs/CLAIMS.md`'s
"Key Compromise Notice" section) that talks to a real external
