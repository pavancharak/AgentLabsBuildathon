...
<CardGroup cols={2}>
  ...
  <Card title="Objections and Evidence" icon="scale-balanced" href="/trust-and-claims/objections-and-evidence">
    The same claims, reorganized as the specific objections a regulator or design partner would raise.
  </Card>
