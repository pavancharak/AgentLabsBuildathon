...
<Info>
  This page explains a discipline this site follows. For the rule as written for
  someone editing this site, see [Contributing](/contributing).
</Info>

## What it is

[`docs/CLAIMS.md`](https://github.com/pavancharak/parmana/blob/main/docs/CLAIMS.md) is the
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="scale-balanced"
    href="/trust-and-claims/objections-and-evidence"
  >
    The same claims, reorganized as the specific objections a regulator or
    design partner would raise.
  </Card>
