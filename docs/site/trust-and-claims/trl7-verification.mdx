...
<Info>
  This page is sourced from one verification session run against commit
  `b9e3348` on `main` (2026-08-01). Every claim below either cites a file/test
  from that session's own inspection, or says plainly that it rests on
  prior-session evidence it did not re-check. Where something in this session
  didn't go as intended, it's described here in full, not smoothed over, for the
  same reason [The CLAIMS.md discipline](/trust-and-claims/claims-discipline)
  treats a citation as the only thing that makes a claim checkable.
</Info>
...
<CardGroup cols={2}>
  ...
  >
    How every claim on this site maps back to a source, and how to check one
    yourself.
  </Card>
  <Card
  ...
  >
    The permanent boundaries and scoped claims this same discipline has already
    produced.
  </Card>
</CardGroup>
