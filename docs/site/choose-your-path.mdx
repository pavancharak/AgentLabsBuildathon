...
| **Run Parmana on your own infrastructure**, with its own Postgres, in one command                | [Self hosted quickstart](/self-hosted/quickstart), after the [Self hosted overview](/self-hosted/overview)                   | Docker with Docker Compose v2, a clone of the repository                                       | `docker compose up -d --build --wait`                                       |
| **Run Parmana from source** on your own machine, for development                                 | [Local deployment](/deployment/local)                                                                                        | Node 24 or later                                                                               | Follow the page top to bottom                                               |
...
| `502` with code `EXECUTION_OUTCOME_UNKNOWN`    | The action was released and the connector call failed, so it **may** have been performed.                                                                      | **Do not resubmit.** Check the target system, then close the Execution Intent with resolve.                                                                                                   |
...
| -------------------------------------- | ------------------------------------------- | --------------- | ------------------------------------------------------------- |
| TypeScript or JavaScript               | [`@parmana/sdk`](/sdks/typescript) on npm   | 1.3.0           | `npm install @parmana/sdk`                                    |
| Python                                 | [`parmana`](/sdks/python) on PyPI           | 1.3.0           | `pip install parmana`                                         |
| Python, and you verify records offline | `parmana` with the `verify` extra           | 1.3.0           | `pip install "parmana[verify]"`                               |
