...
| -------------------------------------- | ------------------------------------------- | --------------- | ------------------------------------------------------------- |
| TypeScript or JavaScript               | [`@parmana/sdk`](/sdks/typescript) on npm   | 1.2.0           | `npm install @parmana/sdk`                                    |
| Python                                 | [`parmana`](/sdks/python) on PyPI           | 1.2.0           | `pip install parmana`                                         |
| Python, and you verify records offline | `parmana` with the `verify` extra           | 1.2.0           | `pip install "parmana[verify]"`                               |
