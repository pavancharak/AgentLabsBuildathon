...
<Info>
  **[AVAILABLE]**, every command below was run in this session against the
  repo's actual code, commit `651497a`.
</Info>
...
<Note>
  ...
  exists, and `docs/VERIFICATION-GAPS.md` G-33 for why this became fail-closed
  rather than an easily-missed load-time warning.
</Note>
...
<Note>
  ...
  See `docs/VERIFICATION-GAPS.md` G-38 and G-39.
</Note>
