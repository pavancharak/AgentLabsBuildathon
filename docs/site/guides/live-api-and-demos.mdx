...
|---|---|---|
| `access-control@1.0.0` | Access via auth/MFA/device-trust/session-risk | — |
...
| `llm-tool-call@1.0.0` | AI-initiated tool execution | — |
| `production-deployment@1.0.0` | Production deployments | — |
| `rag-document-access@1.0.0` | Enterprise document retrieval | — |
