...
<Info>
  ...
  deployment. Base URL: `https://parmana-api-real.vercel.app`. Repo copy of this
  guide: `LIVE-API-GUIDE.md` (repo root).
</Info>
...
`paytm:refund` is a real, wired connector on this deployment:
`PAYTM_CONNECTOR_URL`/`PAYTM_CONNECTOR_SHARED_SECRET` point at a real, separately deployed
