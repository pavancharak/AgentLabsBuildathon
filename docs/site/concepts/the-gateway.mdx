...
<Warning>
  **This page corrects a claim this site made through 2026-07-08**: earlier
  material says the gateway is "a library you wire in, not a default," and that
  a stock `packages/api` server gets no content-binding enforcement. That was
  true then. As of commit `651497a` (2026-07-11),
...
[Content Binding & TOCTOU](/concepts/content-binding-toctou) for the full mechanism of the
latter two.
...
[`hubspot`](/integrations/hubspot) (whenever `HUBSPOT_PRIVATE_APP_TOKEN` is configured),
