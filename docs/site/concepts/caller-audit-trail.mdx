...
<Info>
  **[AVAILABLE]**. `packages/api/src/auth/CallerAuditSink.ts`,
  ...
  `CallerAuditChainVerifier.ts`. See `docs/CLAIMS.md` §2.32 and [Objections and
  Evidence](/trust-and-claims/objections-and-evidence) (Domain 3) for the full
  evidence list this page draws from.
</Info>
