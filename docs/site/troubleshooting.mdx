...
**Important:** the connector may already have run by the time this error is returned. Do not assume the
action did not happen. Query `execution_audit_events` for the `business_transaction_id` to see what the
