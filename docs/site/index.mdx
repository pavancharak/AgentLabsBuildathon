...
<Info>
  **Last verified against commit `0e69ed4`, 2026-07-29**, including live local
  runs. Every `[AVAILABLE]` claim on this site cites the source file or test
  that proves it. See [Contributing](/contributing) for the rule this site
  follows.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Roadmap" icon="map" href="/roadmap">
    What's designed but not yet built, stated plainly: KMS custody, real
    enterprise connectors, more.
  </Card>
</CardGroup>
