...
| `supabase` | [AVAILABLE]               | `SupabaseStorageProvider`, `SupabaseBusinessTransactionRepository`, `SupabaseExecutionTrustRecordRepository`. This repo's committed `.env` defaults to this. |
