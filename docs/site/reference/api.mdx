...
| `src/app.ts`                               | Mounts the caller-auth middleware (every route except `/health`), all routes, and the error handler, in order, the error handler must be registered last.                                                                                                                                                                                                                                                                                                                                                                                                |
