...
| The intent, and the Trust Record, each verified offline against the KMS public key only                                                                     | Pass, 23 of 23 checks in the first run and 37 of 37 in the final run, which added closing an intent by hand         |
