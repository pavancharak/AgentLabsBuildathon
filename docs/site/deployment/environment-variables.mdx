...
| Variable            | Required     | Default  | Values or format                 | What it does                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------------------- | ------------ | -------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `PARMANA_STORAGE`   | No           | `memory` | `memory`, `postgres`, `supabase` | Where business transactions and trust records are kept. `memory` loses everything on restart and must not be used in production. `postgres` uses any Postgres through `DATABASE_URL`, and is the name for a self hosted database. `supabase` is the same implementation under its older name, kept so existing deployments are unchanged.                                                                                                                          |
