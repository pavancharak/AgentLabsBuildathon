...
<Warning>
  **[ROADMAP].** Nothing below is built. This is a single honest note, not five
  speculative SDK sections.
</Warning>
...
1. Call the [REST API](/api-reference/introduction) directly, it's small (15 routes) and
