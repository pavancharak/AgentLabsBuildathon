...
<Info>
  **[AVAILABLE]**, **published**, [`parmana` on
  PyPI](https://pypi.org/project/parmana/1.1.5/). Real, public, installable with
  ...
  added a `Website` URL); v1.1.5, published 2026-09-20, is the current version,
  confirmed against the live PyPI registry. v1.1.5 lets the offline verifier
  ...
  [Changelog](/changelog) and the fix history at the bottom of this page.
</Info>
