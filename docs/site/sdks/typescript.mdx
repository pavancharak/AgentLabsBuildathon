...
<Info>
  **[AVAILABLE]**, **published**, [`@parmana/sdk` on
  ...
  v1.1.3, published 2026-09-20 and confirmed via `npm view @parmana/sdk
  version`, adds `serverCode` on `InternalServerError` (see below). v1.1.2,
  published 2026-09-14, added `createBusinessTransaction()`. See the fix history
