...
<Info>
  **[AVAILABLE]**, **published**, `@parmana/sdk` on npm, v1.1.2. Real, public,
  ...
  SDKs (`POST /transactions`). 2026-09-14 added `createBusinessTransaction()`
  (see below) and 11 new tests, all re-verified against a real running local
  server. See the fix history at the bottom of this page.
</Info>
