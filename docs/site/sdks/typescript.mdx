...
<Info>
  **[AVAILABLE]**, **published**, `@parmana/sdk` on npm. Real, public,
  ...
  SDKs (`POST /transactions`). v1.1.2, adding `createBusinessTransaction()` (see
  below), published 2026-09-14 — confirmed via `npm view @parmana/sdk version`.
  See the fix history at the bottom of this page.
</Info>
