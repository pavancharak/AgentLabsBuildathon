...
it should do: what it _does_, traced to the actual source as of **2026-09-05**.
...
who needs to _build on, audit, or extend_ this codebase, not integrate against its HTTP API.
...
| 03  | [Signal-State Verification](03-signal-state-verification.md)                    | Proving declared signals are _true_, not just consistent                             |
