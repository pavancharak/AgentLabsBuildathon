[← Book Index](README.md) · [← Previous: Chapter 14, Policy Governance](14-policy-governance.md)
...
has been approved. Trust chain: Business Approval to `ApprovalPayload` to canonical
serialization to the issuer's own signature to `ApprovalVerifier`, and only then does the
verified fact overwrite whatever the caller itself declared for that signal.
...
[← Book Index](README.md) · [← Previous: Chapter 14, Policy Governance](14-policy-governance.md) · [Next: Chapter 16, Verification, and Two Orphaned Models →](16-verification-and-orphaned-models.md)
