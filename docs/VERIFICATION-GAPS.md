...
item above: 1524 passed, 38 pre-existing skips, 0 failed (up from 1513/1513 passed at the
...
full-codebase pass that produced gaps 24–34 — recorded in this same table because they landed
in the same session and the numbering is otherwise continuous, not because they share that
pass's methodology.
