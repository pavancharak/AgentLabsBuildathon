...
PARMANA MONTHLY MARKET RESEARCH PROMPT (REUSABLE)
...
\*\*Previous Report:\*\* \[PREVIOUS\_MONTH\_REPORT\_DATE]

\*\*Deadline:\*\* Last Friday of month, output by 12:30 PM

\*\*Output format:\*\* Markdown file, 10,000-15,000 words
...
\- Regulatory developments impacting Parmana (by region)

\- Competitive intelligence (new announcements, threat assessment)

\- Market sizing and forecasts (TAM, adoption, trends)

\- Vertical analysis (Payments, Banking, Healthcare)

\- Parmana positioning shifts and strategy implications

\- Timeline and urgency assessment (3/6/12 month outlook)
...
1\. "AI agent governance" latest 2026 regulatory framework

2\. "NIST AI Agent Standards Initiative" latest news \[CURRENT\_YEAR]

3\. "EU AI Act Article 50" compliance deadline updates \[CURRENT\_MONTH]

4\. "RBI FREE-AI" framework enforcement fintech \[CURRENT\_YEAR]

5\. "Singapore IMDA" agentic AI governance latest

6\. "China AI regulation" autonomous agents \[CURRENT\_YEAR]

7\. "UK AI regulation" agents governance \[CURRENT\_YEAR]
...
10\. "Gravitee" AI agent management platform updates \[CURRENT\_MONTH]

11\. "BastionZero" AI agent identity \[CURRENT\_YEAR]

12\. "Charm Tech" OR "1Kosmos" agentic AI authorization latest

13\. "Zest AI" OR "TruFoundry" agent governance \[CURRENT\_MONTH]

14\. AI agent governance platforms \[CURRENT\_YEAR] comparison
...
17\. "Razorpay" agentic payments latest \[CURRENT\_MONTH]

18\. "NPCI" agent payments authorization latest \[CURRENT\_YEAR]

19\. "Stripe" AI agent payments integration \[CURRENT\_YEAR]

20\. "Pine Labs" agent authorization fintech \[CURRENT\_YEAR]

21\. agentic commerce payments market \[CURRENT\_YEAR]

22\. "RBI" payment agent authorization guidance \[CURRENT\_MONTH]

23\. fintech agent security incident latest \[CURRENT\_YEAR]
...
26\. "OpenAI" ChatGPT agent execution control \[CURRENT\_YEAR]

27\. "Google" Gemini agent authorization framework

28\. "MCP" Model Context Protocol security authorization latest
...
31\. agentic AI market size forecast \[CURRENT\_YEAR]

32\. autonomous agents market TAM \[CURRENT\_YEAR] \[NEXT\_YEAR]

33\. "McKinsey" OR "Gartner" agentic commerce forecast

34\. enterprise AI agent adoption survey \[CURRENT\_YEAR]

35\. "State of AI" report agent security incidents \[CURRENT\_YEAR]
...
\## \[Finding Title] (\[Publication Date])
...
\*\*Why it matters to Parmana:\*\*

\- Competitive impact

\- Market opportunity shift
...
\*\*Reporting Period:\*\* \[Previous Month] — \[Current Month] \[Year]

\*\*Research Scope:\*\* Regulatory, competitive, market, fintech
...
| Regulatory | \[Status] | \[Status] | ✅/⚠️ |

| Competitive | \[Status] | \[Status] | ✅/⚠️ |
...
| Parmana | ✅ | ✅ | ✅ | Payments | Fintech-first |

| Delinea | ✅ | ✅ | ✅ | Identity | PAM customers |

| Gravitee | ✅ | ✅ | ✅ | Breadth | Platform layer |
...
| Agentic Commerce TAM | McKinsey | $X | $Y | $Z | X% |

| Agent Authorization Market | \[Source] | $X | $Y | $Z | X% |
...
| % organizations with agent incidents | X% | Y% | ↑/→/↓ |

| % treating agents as distinct identities | X% | Y% | ↑/→/↓ |
...
| \[Risk 1] | X% | \[Impact] | \[Mitigation] | \[How to track] |
...
| \[Opp 1] | $X | \[Competitors] | \[Timeline] | \[Action] |
...
\- \[New value prop emphasis]

\- \[New use case to highlight]
...
\- \[Market data showing growth opportunity]
...
\- \[ ] \[Action 2] - Owner: \_\_\_\_\_\_\_\_\_ - Deadline: \[Date]
...
| Aug 2026 | 8/10 | Medium | $500M | High | 18 mo |
...
\- \[ ] All sources have URLs and publication dates

\- \[ ] Report is dated: PARMANA-MARKET-\[MMYYYY].md

\- \[ ] Competitive matrix updated vs. previous month

\- \[ ] Market TAM shows month-over-month change

\- \[ ] Timeline section forecasts next 12 months specifically

\- \[ ] Risk/opportunity probabilities are specific (not vague)

\- \[ ] Next Actions have assigned owners + deadlines

\- \[ ] Report answers: "Has our market window expanded or shrunk?"

\- \[ ] One peer review completed

\- \[ ] Bibliography includes all sources with URLs
...
2\. Notify team: Share report link + 2-minute summary of key findings

3\. Archive: Keep previous reports for trend comparison
...
✅ \*\*Depth:\*\* Analysis should be substantive (not just summaries)

✅ \*\*Tone:\*\* Professional, actionable, strategic

✅ \*\*Audience:\*\* Executives, investors, sales, product teams

✅ \*\*Sections:\*\* All 10 sections (A-J) plus appendix

✅ \*\*Sources:\*\* Every claim has a source with URL
