...
import { LoggingRuntimeComponent } from "./LoggingRuntimeComponent.js";
...
console.log(" Parmana Tutorial 15");

console.log(" Custom Runtime Component");
...
console.log(" CUSTOM RUNTIME COMPONENT COMPLETE");
