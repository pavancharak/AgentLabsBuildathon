...
async function main(): Promise<void> {
  console.log();
  console.log("==================================================");
  console.log("Tutorial 24 - SDK Integration Patterns");
  console.log("==================================================");
  console.log();
  ...
  const trustRecord = await paymentService.releasePayment(transaction);
  ...
  console.log("==================================================");
  console.log("SDK Integration completed successfully.");
  console.log("==================================================");
}
