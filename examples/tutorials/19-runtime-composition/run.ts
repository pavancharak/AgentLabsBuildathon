...
async function main(): Promise<void> {
  ...
  console.log("Runtime successfully composed from:");

  console.log("  ✓ Policy Repository");

  console.log("  ✓ Runtime Component");

  console.log("  ✓ Logging Hook");

  console.log("  ✓ Metrics Hook");
